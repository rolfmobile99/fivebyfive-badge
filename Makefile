...
#
# here, we are just testing an upload of a known hex file to an actual Arduino board (Mega2560)
#
# note: the Mega2560 has two options different: -patmega2560 -cwiring
#
testprogram:
	avrdude -patmega2560 -cwiring -P/dev/tty.usbmodem1411 -b115200 -D -Uflash:w:Blink_12.hex:i

#    avrdude -patmega328p -carduino -P/dev/tty.usbmodem1411 -b115200 -D -Uflash:w:Blink_12.hex:i
#    avrdude -C/Applications/Arduino.app/Contents/Resources/Java/hardware/tools/avr/etc/avrdude.conf -v -v -v -v -patmega328p -carduino -P/dev/tty.usbmodem1411 -b115200 -D -Uflash:w:/var/folders/6l/26tdsfds6zv42np963th5tl00000gp/T/build7261437485191749515.tmp/Blink_12_rolf.cpp.hex:i
