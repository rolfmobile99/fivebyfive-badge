...
//
// forward references (so where these functions appear doesn't matter)
//
...
int main()
{
	...
	// oct 22, 2016
	//static const unsigned char str[]   = "I \xF0 MINI MAKER FAIRE  ";

	// NB aug 31, 2015
	//static const unsigned char str[]   = "PEOPLE EVOLVE AS CONSCIOUSNESS EXPANDS   ";
	//static const unsigned char str[]   = "I \xF0 ZOE   ";

	// NB jun 23, 2014
	//static const unsigned char str[]   = "DIEGO  ";
	//static const unsigned char str[]   = "LIVE AND DIE IN LA  \xF0  ";
	//static const unsigned char str[]   = "GOOD JOB  NICE TRY  \xF0  ";
	//static const unsigned char str[]   = "PV = NRT   CHEM THUG   ";


	// WW mar 9, 2014
	//static const unsigned char str[]   = "I \xF0 CATS AND BUDDER  ";
	//static const unsigned char str[]   = "I AM A MAKER :)  ";
	//static const unsigned char str[]   = "EL SILA ERIN LU E-GOVANED VIN  ";
	//static const unsigned char str[]   = "BOW BEFORE ME FOR I AM SHORTER THAN YOU! :)  ";
	//static const unsigned char str[]   = "AIDEN TATLONGHARI 88 - GO AZURI!  ";

	// CHM feb 3, 2014
	//static const unsigned char str[]   = "IMPORT GRAVITY  ";
	//static const unsigned char str[]   = "HARDER THAN IT LOOKS  ";
	//static const unsigned char str[]   = "I \xF0 SCIENCE  ";
	//static const unsigned char str[]   = "HELLO WORLD \xF0  ";

	// CHM nov 4, 2013
	//static const unsigned char str[]   = "MOOMOO <3 PIKACHU   ";
	//static const unsigned char str[]   = "DON'T BE A BUTT   ";

	// CHM nov 4, 2013
	//static const unsigned char str[]   = "PARTY WAVE  ";
	//static const unsigned char str[]   = "GREETINGZ EARTHLINGS!!!   ";
	//static const unsigned char str[]   = "ILLEGAL SMILE ROCKSTEADY PIRATE   ";
	//static const unsigned char str[]   = "JUNE BUG!!!  ";

	//static const unsigned char str[]   = "I \xF0 CODAME    ";
	//static const unsigned char str[]   = "BOO!   HAPPY HALLOWEEN!   ";

	//static const unsigned char str[]   = "I \xF0 TECHLIMINAL!  ";
	//static const unsigned char str[]   = "I DON'T KNOW!!!  ";		// micah (age 10) at TL
	//static const unsigned char str[]   = "JOHN HERSEY ROBOT  ";

	//static const unsigned char str[]   = "I \xF0 SCIENCE!  ";

	// WW jun 22, 2013
	//static const unsigned char str[]   = "CAPTAIN IRENE GROSSRUBATSCHER  ";
	//static const unsigned char str[]   = "I \xF0 KITTENS  ";
	//static const unsigned char str[]   = "I LOVE MINECRAFT  ";

	//static const unsigned char str[]   = "TYPE A MACHINES  ";
	//static const unsigned char str[]   = "I \xF0 TYPE A MACHINES  ";
	//static const unsigned char str[]   = "I \xF0 BAY BRIDGE  I \xF0 BAY LIGHTS   ";
	//static const unsigned char str[]   = "I \xF0 SCIENCE!   ";

	// WW mar 3, 2013
	//static const unsigned char str[]   = "I \xF0 HOMESCHOOL!  ";
	//static const unsigned char str[]   = "I \xF0 FENCING!  ";
	//static const unsigned char str[]   = "I \xF0 BREWING  ";
	//static const unsigned char str[]   = "I \xF0 PRISCILLA  ";
	//static const unsigned char str[]   = "I \xF0 HACKING  ";
	//static const unsigned char str[]   = "KISS THE GEEK \xF0 \xF0 \xF0  ";
	//static const unsigned char str[]   = "MADE THIS AT WORKSHOP WEEKEND  ";
	//static const unsigned char str[]   = "THIS IS COOL!  ";
	
	// CHM jan 28, 2013
	//static const unsigned char str[]   = "SOLDIER ON  \xF0  SOLDER ON  \xF0  ";

	// CHM jan 14, 2013
	//static const unsigned char str[]   = "PIERRE \xF0 SHAHAR!    ";
	//static const unsigned char str[]   = "HELLO WORLD!  ";
	//static const unsigned char str[]   = "MAKE MY DAY!  ";
	//static const unsigned char str[]   = "PRETTY FUCKIN CLASSY.  ";
	//static const unsigned char str[]   = "BYTE MY SHINY METAL ASS  ";
	//static const unsigned char str[]   = "OODLES OF NOODLES \xF0  ";
